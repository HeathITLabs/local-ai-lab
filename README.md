...
- ComfyUI: http://localhost:8188/ (`gpu-nvidia` profile)
...
ComfyUI uses host bind mounts instead of Docker volumes:

- `E:/AI/models` -> `/app/models`
- `E:/AI/ComfyUI/input` -> `/app/input`
- `E:/AI/ComfyUI/output` -> `/app/output`
- `E:/AI/ComfyUI/user` -> `/app/user`
- `E:/AI/ComfyUI/custom_nodes` -> `/app/custom_nodes`
